...
| [`PROPOSAL-REAUTHENTICATION.md`](PROPOSAL-REAUTHENTICATION.md) | **Decided and implemented 2026-08-13 — a historical design record, superseded and authoritative for nothing.** The re-authentication design for AUDIT 5.41, approved with option A1 and shipped as P9.S10 and P9.S11. Its value now is the options weighed and rejected; `AUDIT.md`, the roadmap rows and `BACKEND.md` own what was built. | Historical design record | Before revisiting the re-authentication trade, or designing anything touching session credentials. | No; superseded 2026-08-13 |
