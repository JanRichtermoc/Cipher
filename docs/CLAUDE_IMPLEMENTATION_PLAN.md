...
|---|---|
| Phase | **P7 is in progress: P7.S01 is done, P7.S02 and P7.S03 are not.** P6's numbered steps are all done; P1–P4 complete. P5's numbered steps are all done and six of its seven exit criteria are ticked; the seventh is a hardware decision, not engineering work, so P6 proceeds beside it rather than behind it. |
...
- [ ] **Not an exit criterion, recorded so it is not mistaken for one:** AUDIT **3.9**, the live
      relay learning the sender from the bearer token, stays OPEN. P7.S02 (length bucketing) and
      P7.S03 (push-token hardening) are still to do.
