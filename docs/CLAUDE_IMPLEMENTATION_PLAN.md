...
|-------|------|-----------|
| 3.8 | First-contact address is relabellable — narrowed by P7.S01, and again on 2026-08-10 when the addressed **first** message was refused outright. What remains is the self-issued certificate: a circle member can still name another account, in the ciphertext as well as the certificate | P5.S12 / P7; **status** resolved by P9.S09 |
| 3.9 | The live relay still learns the sender from the bearer token on send (split from 3.4 when P7.S01 closed it) | unscheduled; **status** resolved by P9.S09 |
...
- [ ] High findings closed or formally ACCEPTED with compensating controls — **P9.S09**
