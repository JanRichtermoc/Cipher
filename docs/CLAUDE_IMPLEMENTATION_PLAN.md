...
| Completed P5 product steps | P5.S01, P5.S02, P5.S05, P5.S06, P5.S08, P5.S09, P5.S10, P5.S11, P5.S12, and P5.S13. |
| Security-remediation queue | Empty of closed work: 5.26, 5.27, 1.14, 6.14, 6.13, 5.28, 5.29, 5.32, 5.33 and 5.34 are closed; 5.29 reached the live box 2026-08-06 and 5.32 on 2026-08-07. 5.34 is client-only and needs no deploy. **Two rows are OPEN** — 6.17, the other finding from the P5.S13 field run, still unstarted, and 5.1. `AUDIT.md` is authoritative, and a finding's CLOSED status describes the repository: check the deployed revision against `origin/main` before assuming the staging relay carries it (`RUNBOOK-VPS.md`, Deployed revision). **5.32 is why that check exists, and 5.33 is why it is not paranoia** — both passed CI while the relay a real iPhone was talking to did not have them. |
| Next planned feature | **P5.S13 is done** (2026-08-07, both directions, real iPhone plus simulator). Next is **P5.S14**, which closes 5.1 and 5.3 — read 5.1 first: it carries an operator-accepted device residual *and* a push clause (P7.S03) that P5.S14 must reconcile rather than assume. Of the two field findings, **5.34 is closed (2026-08-07)** and 6.17 is unstarted; neither blocks P5.S14. |
