...
|---|---|
| Phase | **P7 is in progress: P7.S01 and P7.S02 are done, P7.S03 is not.** P6's numbered steps are all done; P1–P4 complete. P5's numbered steps are all done and six of its seven exit criteria are ticked; the seventh is a hardware decision, not engineering work, so P6 proceeds beside it rather than behind it. |
