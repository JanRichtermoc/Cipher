...
| **P9.S06** | Incident response runbook: compromise, pin rotation, mass revoke, key rotation. **Unblocked 2026-08-11** by the amendment above — it is documentation and touches no host, so nothing in it ever waited on a purchase. | AI | Runbook exists and is walkable | — |
